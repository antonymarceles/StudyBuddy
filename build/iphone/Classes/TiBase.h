...
// in simulator we redefine to format for StudyBuddy Developer console
...
{\
	NSString * exceptionName = [@"org.studybuddy." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.studybuddy";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIStudyBuddyNativeItemNone = -1, 
	UIStudyBuddyNativeItemSpinner = -2,
	UIStudyBuddyNativeItemProgressBar = -3,
	
	UIStudyBuddyNativeItemSlider = -4,
	UIStudyBuddyNativeItemSwitch = -5,
	UIStudyBuddyNativeItemMultiButton = -6,
	UIStudyBuddyNativeItemSegmented = -7,
	
	UIStudyBuddyNativeItemTextView = -8,
	UIStudyBuddyNativeItemTextField = -9,
	UIStudyBuddyNativeItemSearchBar = -10,
	
	UIStudyBuddyNativeItemPicker = -11,
	UIStudyBuddyNativeItemDatePicker = -12,
	
	UIStudyBuddyNativeItemInfoLight = -13,
	UIStudyBuddyNativeItemInfoDark = -14,
	
	UIStudyBuddyNativeItemDisclosure = -15,
	
	UIStudyBuddyNativeItemContactAdd = -16
};
