...
@interface StudyBuddyObject : KrollCoverageObject {
#else
@interface StudyBuddyObject : KrollObject {
#endif
@private
...
extern NSString * StudyBuddy$ModuleRequireFormat;
