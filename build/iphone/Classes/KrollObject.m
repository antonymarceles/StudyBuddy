 ...
 * Copyright (c) 2009-2011 by StudyBuddy, Inc. All Rights Reserved.
...
//@interface StudyBuddyObject : NSObject
//@end

@interface StudyBuddyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StudyBuddyObject class]])
		{
			for (NSString *key in [[(StudyBuddyObject*)o modules] allKeys])
			{
